...
df_groupedmonth_case7["aridlowwateruse_dif_olsvsnormal"].hist(bins=10)
...
# ## Applying the thresholds once using ols_ols10 which means. 
# 
# 1. Apply a 10y moving window ordinary least square regression on riverdiscarge and wateruse
# 1. Apply a full range (1961-2014) ordinary least square regression on ols10_riverdischarge and ols10_ptotwn
# 1. Apply the thresholds. 
# 
# The alternative is applying the full ols regression on the raw time series directly. This is a good alternative but since water stress is calculated using the ols10 data, the ols_ols10 method is preferred. 
# 
