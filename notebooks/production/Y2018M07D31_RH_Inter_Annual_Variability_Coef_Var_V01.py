...
'SELECT'
  ...
  ' month,'
  ' year,'
  ' stddev_riverdischarge_m_30spfaf06/ nullif(avg_riverdischarge_m_30spfaf06,0) AS cv_riverdischarge_m_30spfaf06'
' FROM'
  ' `{}.{}`'.format(BQ_OUTPUT_DATASET_NAME,BQ_INPUT_TABLE_NAME)
)
