...
#c.JupyterHub.data_files_path = '/root/anaconda3/share/jupyter/hub'
...
#  
#  Use with ssl_key
c.JupyterHub.ssl_cert = '/.keys/jupyterhub.crt'

## Path to SSL key file for the public facing interface of the proxy
#  
#  Use with ssl_cert
c.JupyterHub.ssl_key = '/.keys/jupyterhub.key'
...
# Added by Rutger based on https://www.youtube.com/watch?v=gSVvxOchT8Y

# set of users allowed to use the Hub
c.Authenticator.whitelist = {'rutgerhofste'}

# set of users who can administer the Hub itself
c.Authenticator.admin_users = {'rutgerhofste'}
